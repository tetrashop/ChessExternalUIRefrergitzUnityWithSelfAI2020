# Chessexternaluirefrergitzunitywithselfai2020
...
```bash
git clone https://github.com/tetrashop/ChessExternalUIRefrergitzUnityWithSelfAI2020.git
cd ChessExternalUIRefrergitzUnityWithSelfAI2020
# دستورات نصب
```
...
- **URL:** [  🚀 دیپلوی ChessExternalUIRefrergitzUnityWithSelfAI2020 روی Vercel...
    ❌ دیپلوی ناموفق!
...
Vercel CLI 58.5.1 (Node.js 26.4.0)
  ...
  Directory       ~/github/ChessExternalUIRefrergitzUnityWithSelfAI2020
...
Learn More: https://vercel.com/docs/projects/overview#project-name](  🚀 دیپلوی ChessExternalUIRefrergitzUnityWithSelfAI2020 روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
...
- **وضعیت:** ✅ فعال
- **آخرین به‌روزرسانی:** 2026-08-15 17:55
...
<!-- Trigger deploy: Mon Aug 17 01:47:30 +0330 2026 -->

## 🌐 دیپلوی

- **URL:** [https://ChessExternalUIRefrergitzUnityWithSelfAI2020.vercel.app](https://ChessExternalUIRefrergitzUnityWithSelfAI2020.vercel.app)
- **وضعیت:** ✅ فعال
